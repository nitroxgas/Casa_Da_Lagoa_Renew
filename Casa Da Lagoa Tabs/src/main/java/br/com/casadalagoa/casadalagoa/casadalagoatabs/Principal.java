...
public class Principal extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            case R.id.menu_toggle_log: return true;
            case R.id.menu_atualizar: new HttpAsyncTask().execute("http://georgesilva.dyndns.org:8080/"); return true;
           /* case R.id.menu_devices:   return true;
            case R.id.menu_external:  return true;
            case R.id.menu_internal:  return true;
            */
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                case 4: textView.setText(getString(R.string.title_section4)); break;
                case 2: textView.setText(getString(R.string.title_section1)); break;
                case 3: textView.setText(getString(R.string.title_section2)); break;
                case 1: textView.setText(getString(R.string.title_section3));
            }
